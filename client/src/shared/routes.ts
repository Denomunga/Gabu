...
export const api = {
	auth: {
		me: { path: "/api/users/profile", method: "GET", responses: { 200: any, 401: any } },
		login: { path: "/api/auth/login", method: "POST", responses: { 200: any, 401: any } },
		register: { path: "/api/auth/register", method: "POST", responses: { 201: any } },
		logout: { path: "/api/logout", method: "POST", responses: { 204: any } },
	},
	settings: {
	...
	locations: {
		...
		subCounties: { path: "/api/locations/sub-counties/:countyId", method: "GET", responses: { 200: z.array(any) } },
		areas: { path: "/api/locations/areas/:subCountyId", method: "GET", responses: { 200: z.array(any) } },
	},
	newsletter: {
	...
	emailChange: {
		...
		list: { path: "/api/email-change/list", method: "GET", responses: { 200: z.array(any) } },
		review: { path: "/api/email-change/review/:id", method: "POST", input: z.any(), responses: { 200: any } },
	},
	orders: {
